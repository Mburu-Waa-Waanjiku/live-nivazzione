      ...
      <>
        ...
        <div className="bannerwidth" style={{ overflowX: 'hidden' }}>
          ...
          <Swiper                    
           ...
           >
            <SwiperSlide >
                <Image height={799} width={1919} alt="" src={banner[1].image[0]} className="shadow object-cover h-auto w-100 bg-gray-100" />
            </SwiperSlide>
            <SwiperSlide>
                <Image height={799} width={1919} alt="" src={banner[3].image[0]} />
            </SwiperSlide>
            <SwiperSlide>
                <Image height={799} width={1919} alt="" src={banner[12].image[0]} />
            </SwiperSlide>
          </Swiper> 
        </div>
