                      ...
                      <TableBody>
                        {banners.map((banner) => (
                          <TableRow key={banner._id}>
                            <TableCell><Image width={80} height={80} alt={banner.smallText[0]} src={banner.image[0]}></Image></TableCell>                            
                            <TableCell>
                              {banner._id.substring(20, 24)}
                            </TableCell>
                            <TableCell>{banner.smallText[0]}</TableCell>
