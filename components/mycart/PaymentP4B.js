...
function PaymentP4B() {
    ...
    const { handleChangeBag, openLogin, handleClosep4b, handleClosePayp4b } = useStateContext();
                  ...
                  <div style={{maxWidth: 300}}>
                    ...
                    <div className="flex justify-center">
                      <Button
                       ...
                       >
                        {!awaitingConfirm ? 'CONFIRM' : <span><CircularProgress className="loadinbutton"/></span>}
                      </Button>
                    </div>
                  </div>
                </div>) : (
                  ...
                  <div className="mb-4 pt-8">
                    ...
                    >
                      ...
                      <option disabled style={{color: 'green', display:'block'}}>
                        YOU&apos;RE OUTSIDE NAIROBI AND ITS ENVIRONS ?? <br/>
                        VISIT us on Whatsapp 👇👇 for customized delivery🛍️ 😊
                      </option>            
                    </select>
                    {errors.county && (
