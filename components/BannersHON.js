...
function BannersHON({collections, categs, banner, mylink, Anclets, Earrings, Necklaces }) {
  ...
  const [Offers, setOffers] = useState("http://www.shiglam.com/offers");
  const [Hot, setHot] = useState("http://http://www.shiglam.com/trending");
  const [New, setNew] = useState("http://http://www.shiglam.com/new-products");
